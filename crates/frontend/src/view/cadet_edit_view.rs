                ...
                form { onsubmit: on_submit,
                    div { class: "zsu-input-grid",
                        ...
                        RegularDateInputField {
                            ...
                            required: true,
                            disabled: !has_write_permission,
                            value: if new_cadet { "" } else { cadet.birth_date_as_dot_dd_mm_yyyy_str() },
                        }
                    }
...
fn CadetCourseListView(
    ...
    rsx! {
        CadetCourseGridView {
            ...
            cadet_course_create_button_visible: cadet_edit_id_signal.read().is_some(),
