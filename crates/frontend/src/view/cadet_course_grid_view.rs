                ...
                table: rsx! {
                    table { class: "zsu-table",
                        thead { class: "zsu-table-thead",
                            tr {
                                if visible_column("full_name") || visible_column("tax_number") {
                                ...
                                if visible_column("military_rank") {
                                    th { class: "zsu-table-th", {FeApplicationContext::translate("military-rank")} }
                                }
                                if visible_column("source_unit") {
                                    th { class: "zsu-table-th", {FeApplicationContext::translate("source-unit")} }
                                }
                                ...
                                if visible_column("category") {
                                    th { class: "zsu-table-th", {FeApplicationContext::translate("category")} }
                                }
                                if visible_column("training_location") {
                                    th { class: "zsu-table-th", {FeApplicationContext::translate("training-location")} }
                                }
                                if visible_column("start_date") || visible_column("end_date") {
                                    th { class: "zsu-table-th", {FeApplicationContext::translate("start-end-date")} }
                                }
            ...
            if visible_column("full_name") {
                td { class: "zsu-table-td",
                    div { class: "font-medium text-grey-light",
                        ...
                        br {}
                        {format!("{}", cadet_course_entry.tax_number())}
                    }
                }
            }
            if visible_column("birth_date") {
                td { class: "zsu-table-td",
                    {format!("{}", cadet_course_entry.birth_date_as_dot_dd_mm_yyyy_str())}
                }
            }
            if visible_column("military_rank") {
