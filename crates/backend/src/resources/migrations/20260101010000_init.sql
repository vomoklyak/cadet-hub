...
create index if not exists idx_cadet_course_category on cadet_courses(category);
create index if not exists idx_cadet_course_specialty_code on cadet_courses(specialty_code);
create index if not exists idx_cadet_course_start_date on cadet_courses(start_date);
create index if not exists idx_cadet_course_end_date on cadet_courses(end_date);
create index if not exists idx_cadet_course_updated_at on cadet_courses(updated_at);