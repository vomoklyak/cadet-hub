...
use crate::validator::validator::{
    consistent_tax_number_with_birth_date_or_passport_number_entry, dot_dd_mm_yyyy_date,
...
pub struct ImpexCadetCourseEntry {
    ...
    full_name: String,
    #[validate(custom(function = "dot_dd_mm_yyyy_date"))]
    birth_date: String,
    #[validate(custom(function = "not_blank_str"))]
    tax_number: String,
    #[validate(custom(function = "not_blank_str"))]
    ...
    completion_certificate_number: String,
    notes: Option<String>,
    skip_optional_validation: Option<bool>,
    error: Option<String>,
}