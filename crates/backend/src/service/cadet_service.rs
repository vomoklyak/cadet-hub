...
use common::model::{
    Cadet, CadetCourse, CadetCourseEntry, CadetCourseStatisticEntry, CADET_COURSE_STRUCT_NAME,
    CADET_STRUCT_NAME,
};
...
impl CadetService {
    ...
    pub(crate) async fn delete_cadets_by_search_request(
        &self,
    ...
    pub(crate) async fn count_cadets_by_search_request(
        &self,
        request: SearchCadetRequest,
    ...
    pub(crate) async fn count_cadet_course_entries_by_search_request(
        &self,
    ...
    pub(crate) async fn delete_cadet_courses_by_search_request(
        &self,
        request: SearchCadetCourseRequest,
    ) -> CadetHubBeResult<()> {
        self.cadet_repository
