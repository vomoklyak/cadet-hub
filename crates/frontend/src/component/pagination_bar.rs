use crate::symbol::{PAGE_INDEX, PAGE_NEXT, PAGE_PREVIOUS, PAGE_SIZE};
            ...
            div { class: "flex items-center justify-center px-1 bg-zsu-green-dark-light border border-zsu-green-light rounded-xl gap-1",
                ...
                div { class: "flex items-center gap-2 px-2",
                    PaginationSelect {
                        ...
                        options: rsx! {
                            option { class: "bg-zsu-green-dark-light", selected: true,
                                {format!("{} {}", PAGE_INDEX, pagination_signal.read().page_index + 1)}
                            }
                        },
                    }
                        ...
                        options: rsx! {
                            for page_size_index in 1..=5 {
                                option {
                                    ...
                                    {format!("{} {}", PAGE_SIZE, page_size_index * 20)}
                                }
                            }
                        },
                    }
