...
pub struct SearchCadetCourseRequest {
    ...
    specialty_codes: Option<Vec<String>>,
    birth_date_after: Option<i64>,
    birth_date_before: Option<i64>,
...
#[builder(setter(into))]
#[getset(get = "pub", set = "pub")]
pub struct WriteExcelFileRequest {
    path: String,
}

impl WriteExcelFileRequest {
    pub fn new(path: String) -> Self {
        WriteExcelFileRequestBuilder::default()
            .path(path)
            .build()
...
pub struct RestoreDbRequest {
    path: String,
    db_file_name: String,
    encryption_key_file_name: String,
}
