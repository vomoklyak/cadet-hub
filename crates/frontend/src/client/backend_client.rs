...
use common::model::{
    Cadet, CadetCourse, ExcelTemplate, ExcelTemplateName, BackupDbRequest, ImpexCadetCourseEntry,
    RestoreDbRequest, ReadExcelFileRequest, WriteExcelFileRequest,
};
use common::model::{
...
impl BackendClient {
    ...
    pub async fn import_db(
        ...
        let backend = self.backend.clone();
        execute_backend_task(move || async move {
            backend.admin_facade.import_db(actor_user, request).await
        })
        .await
    }
    ...
    pub async fn export_db(
        ...
        let backend = self.backend.clone();
        execute_backend_task(move || async move {
            backend.admin_facade.export_db(actor_user, request).await
        })
        .await
    }
    ...
    ) -> CadetHubFeResult<ExcelTemplate> {
        let backend = self.backend.clone();
        execute_backend_task(move || async move {
            backend
                .impex_facade
    ...
    ) -> CadetHubFeResult<Vec<ImpexCadetCourseEntry>> {
        let backend = self.backend.clone();
        execute_backend_task(move || async move {
            backend
                .impex_facade
                .read_excel_file(actor_user, request)
                .await
        })
        .await
    }
    ...
    pub async fn write_excel_file(
        ...
        execute_backend_task(move || async move {
            backend
                .impex_facade
                .write_excel_file(actor_user, request, entities)
                .await
        })
        .await
    }
    ...
    pub async fn delete_cadets_by_search_request(
        ...
        execute_backend_task(move || async move {
            backend
                .cadet_facade
                .delete_cadets_by_search_request(actor_user, request)
                .await
        })
        .await
    }
    ...
    pub async fn count_cadets_by_search_request(
        ...
        actor_user: User,
        request: SearchCadetRequest,
    ) -> CadetHubFeResult<i64> {
        let backend = self.backend.clone();
        execute_backend_task(move || async move {
            backend
                .cadet_facade
                .count_cadets_by_search_request(actor_user, request)
                .await
        })
        .await
    }
    ...
    pub async fn get_cadets_by_search_request(
        ...
        execute_backend_task(move || async move {
            backend
                .cadet_facade
                .get_cadets_by_search_request(actor_user, request)
                .await
        })
        .await
    }
    ...
    pub async fn delete_cadet_courses_by_search_request(
        &self,
        actor_user: User,
        request: SearchCadetCourseRequest,
    ) -> CadetHubFeResult<()> {
        ...
        execute_backend_task(move || async move {
            backend
                .cadet_facade
                .delete_cadet_course_by_search_request(actor_user, request)
                .await
        })
        .await
    }
    ...
    pub async fn count_cadet_course_entries_by_search_request(
        ...
        execute_backend_task(move || async move {
            backend
                .cadet_facade
                .count_cadet_course_entries_by_search_request(actor_user, request)
                .await
        })
        .await
    }
