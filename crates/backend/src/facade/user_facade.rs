...
mod tests {
    ...
    use crate::test::test_util::{actor_user_admin, actor_user_reader, actor_user_writer, user};
    use common::model::UserRole;
    use common::model::{PageRequest, SearchUserRequestBuilder, UpdateUserRequestBuilder};
    ...
    async fn should_login() {
        ...
        let user_hashed_password = "$argon2i$v=19$m=16,t=2,p=1$UnZySE5UNHd2SnYwMThZMEN6RTcxQQ$UkBw+0scw3GCl6piqm00HQ";
