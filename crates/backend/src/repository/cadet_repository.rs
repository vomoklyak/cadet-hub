...
pub(crate) trait CadetRepository {
    ...
    async fn delete_cadets_by_search_request(
        &self,
        request: SearchCadetRequest,
    ) -> CadetHubBeResult<()>;
    async fn find_cadet_by_id(&self, id: i64) -> CadetHubBeResult<Option<Cadet>>;
    async fn count_cadets_by_search_request(
        &self,
        request: SearchCadetRequest,
    ) -> CadetHubBeResult<i64>;
    async fn find_cadets_by_search_request(
        &self,
        request: SearchCadetRequest,
    ...
    async fn delete_cadet_courses_by_search_request(
        &self,
...
impl CadetRepository for DefaultCadetRepository {
    ...
    async fn update_cadet(&self, cadet: Cadet) -> CadetHubBeResult<Cadet> {
        ...
        let cadet = sqlx::query_as::<_, CadetEntity>(update_statement)
            ...
            .bind(cadet_entity.updated_at().clone())
    ...
    async fn delete_cadets_by_search_request(
        ...
        info!("Delete cadets: {}", search_cadet_request_str(&request));
        let mut query_builder: QueryBuilder<Sqlite> = QueryBuilder::new(
            r#"
            DELETE FROM cadets WHERE id IN (
                SELECT c.id FROM cadets c WHERE 1=1
        "#,
        );
    ...
    async fn count_cadets_by_search_request(
        ...
        info!("Count cadets: {}", search_cadet_request_str(&request));
    ...
    async fn find_cadets_by_search_request(
        ...
        info!("Find cadets: {}", search_cadet_request_str(&request));
        let mut query_builder: QueryBuilder<Sqlite> =
    ...
    async fn update_cadet_course(
        ...
        let cadet_course = sqlx::query_as::<_, CadetCourseEntity>(update_statement)
            ...
            .bind(cadet_course_entity.updated_at().clone())
    ...
    async fn delete_cadet_courses_by_search_request(
        ...
        info!(
            "Delete cadet courses: {}",
            search_cadet_course_request_str(&request)
        );
        let mut query_builder: QueryBuilder<Sqlite> = QueryBuilder::new(
            r#"
            DELETE FROM cadet_courses WHERE id IN (
                SELECT cc.id FROM cadets c INNER JOIN cadet_courses cc ON (c.id = cc.cadet_id) WHERE 1=1
        "#,
        );
        ...
        query_builder
            ...
            .await
            .map_err(db_error_handler::handle)?;
        info!("Cadet course entries deleted");
        Ok(())
    }
    ...
    async fn find_cadet_course_statistic_entries_by_search_request(
        ...
        info!(
            "Find cadet course statistic entries: {}",
            search_cadet_course_request_str(&request)
        );
        let mut query_builder: QueryBuilder<Sqlite> = QueryBuilder::new(
            r#"
    ...
    E: Executor<'a, Database = Sqlite>,
{
    ...
    let cadet_id = sqlx::query(upsert_statement.as_str())
        ...
        .bind(cadet_entity.last_name().clone())
        .bind(cadet_entity.birth_date().clone())
        .bind(cadet_entity.created_at().clone())
        .bind(cadet_entity.updated_at().clone())
        .fetch_one(executor)
        .await
        .map_err(db_error_handler::handle)?
    ...
    E: Executor<'a, Database = Sqlite>,
{
    ...
    let cadet_course_id = sqlx::query(upsert_statement.as_str())
        ...
        .bind(cadet_course_entity.completion_certificate_number().clone())
        .bind(cadet_course_entity.notes().clone())
        .bind(cadet_course_entity.created_at().clone())
        .bind(cadet_course_entity.updated_at().clone())
        .fetch_one(executor)
        .await
        .map_err(db_error_handler::handle)?
...
fn apply_cadet_course_search_filters<'a>(
    ...
    add_in_clause(query_builder, "cc.category", request.categories());
    add_in_clause(
        query_builder,
        "cc.specialty_code",
        request.specialty_codes(),
    );
    if let Some(start_date_after) = request.start_date_after() {
        query_builder.push(" AND cc.start_date >= ");
    ...
    if let Some(end_date_after) = request.end_date_after() {
        query_builder.push(" AND cc.end_date >= ");
    ...
    if let Some(updated_after) = request.updated_after() {
        query_builder.push(" AND cc.updated_at >= ");
...
fn apply_cadet_search_filters<'a>(
    ...
    updated_after: &'a Option<i64>,
    updated_before: &'a Option<i64>,
) {
    ...
    if let Some(updated_after) = updated_after {
        query_builder.push(" AND c.updated_at >= ");
        query_builder.push_bind(updated_after);
    }
...
fn search_cadet_request_str(request: &SearchCadetRequest) -> String {
    format!(
        "number_of_tax_numbers={:?}, number_of_last_names={:?}, birth_date_after={:?}, birth_date_before={:?}, updated_after={:?}, updated_before={:?}, page_index={}, page_size={}",
...
fn search_cadet_course_request_str(request: &SearchCadetCourseRequest) -> String {
    format!(
            "number_of_tax_numbers={:?}, number_of_last_names={:?}, number_of_categories={:?}, number_of_specialty_codes={:?}, birth_date_after={:?}, birth_date_before={:?}, start_date_after={:?}, start_date_before={:?}, end_date_after={:?}, end_date_before={:?}, updated_after={:?}, updated_before={:?}, page_index={}, page_size={}",
            request.tax_numbers().as_ref().map_or(0, |vector| vector.len()),
            request.last_names().as_ref().map_or(0, |vector| vector.len()),
            request.categories().as_ref().map_or(0, |vector| vector.len()),
            request.specialty_codes().as_ref().map_or(0, |vector| vector.len()),
            request.birth_date_after(),
            request.birth_date_before(),
            request.start_date_after(),
            request.start_date_before(),
            request.end_date_after(),
...
mod tests {
    ...
    async fn sut() -> DefaultCadetRepository {
        ...
        let database = Database::connect(&config).await.expect("failed init DB");
    ...
    async fn should_save_cadet() {
        // Given
        let now = date_time_util::now_utc_timestamp();
        let cadet = cadet(1);
        let sut = sut().await;
        ...
        assert_that(result.created_at()).is_greater_than_or_equal_to(&Some(now));
        assert_that(result.updated_at()).is_greater_than_or_equal_to(&Some(now));
    }
    ...
    async fn should_save_cadet_case_conflict() {
        // Given
        let sut = sut().await;
        let cadet_one = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
    ...
    async fn should_update_cadet() {
        ...
        let result = sut
            ...
            .await
            .expect("failed find cadet")
            .expect("not existent cadet");

        // Then
        assert_that(&result).is_equal_to(&updated_cadet);
        assert_that(result.created_at()).is_equal_to(updated_cadet.created_at());
        assert_that(result.updated_at()).is_greater_than_or_equal_to(updated_cadet.updated_at());
    }
    ...
    async fn should_update_cadet_case_conflict() {
        ...
        let sut = sut().await;
        let cadet_one = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
        let mut cadet_two = sut.save_cadet(cadet(2)).await.expect("failed save cadet");
        cadet_two.set_tax_number(cadet_one.tax_number().clone());
    ...
    async fn should_save_cadet_if_not_exist() {
        ...
        let result = sut
            ...
            .await
            .expect("failed save cadet if not exist");
    ...
    async fn should_count_cadets_by_search_request() {
        ...
        // When
        let result = sut
            .count_cadets_by_search_request(request)
            .await
    ...
    #[tokio::test]
    async fn should_find_cadets_by_search_request_case_pagination() {
        // Given
        let sut = sut().await;
        sut.save_cadet(cadet(1)).await.expect("failed save cadet");
        sut.save_cadet(cadet(2)).await.expect("failed save cadet");
        ...
        // When
        let result = sut
            .find_cadets_by_search_request(request)
            .await
            .expect("failed find cadet courses");
    ...
    #[tokio::test]
    async fn should_find_cadets_by_search_request() {
        // Given
        let sut = sut().await;
        let cadet = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
    ...
    #[tokio::test]
    async fn should_find_cadets_by_search_request_case_another_tax_number() {
        // Given
        let sut = sut().await;
        let cadet = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
    ...
    #[tokio::test]
    async fn should_find_cadets_by_search_request_case_another_last_name() {
        // Given
        let sut = sut().await;
        let cadet = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
        let mut request = cadet_search_request(&cadet);
    ...
    #[tokio::test]
    async fn should_find_cadets_by_search_request_case_older_birth_date() {
        // Given
        let sut = sut().await;
        let cadet = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
        let mut request = cadet_search_request(&cadet);
    ...
    #[tokio::test]
    async fn should_find_cadets_by_search_request_case_newer_birth_date() {
        // Given
        let sut = sut().await;
        let cadet = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
        let mut request = cadet_search_request(&cadet);
    ...
    #[tokio::test]
    async fn should_find_cadets_by_search_request_case_newer_updated_after() {
        // Given
        let sut = sut().await;
        let cadet = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
        let mut request = cadet_search_request(&cadet);
        request.set_updated_after(Some(cadet.updated_at().clone().unwrap_or_default() + 2000));
    ...
    #[tokio::test]
    async fn should_find_cadets_by_search_request_case_older_updated_before() {
        // Given
        // Given
        let sut = sut().await;
        let cadet = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
        let mut request = cadet_search_request(&cadet);
        request.set_updated_before(Some(cadet.updated_at().clone().unwrap_or_default() - 2000));
    ...
    async fn should_delete_cadets_by_search_request() {
        ...
        // When
        sut.delete_cadets_by_search_request(request)
            .await
            .expect("failed delete cadets by search request");
        let result = sut
            .find_cadet_by_id(cadet.require_id())
            .await
            .expect("failed find cadet by id");
    ...
    fn cadet_search_request(cadet: &Cadet) -> SearchCadetRequest {
        SearchCadetRequestBuilder::default()
            ...
            .updated_after(date_time_util::now_utc_timestamp() - 1000)
            .updated_before(date_time_util::now_utc_timestamp() + 1000)
            .page_request(PageRequest::all())
            .build()
    ...
    async fn should_update_cadet_course() {
        ...
        assert_that(result.created_at()).is_equal_to(updated_cadet_course.created_at());
        assert_that(result.updated_at())
            .is_greater_than_or_equal_to(updated_cadet_course.updated_at());
    }
    ...
    async fn should_save_cadet_course_if_not_exist() {
        ...
        let result = sut
            ...
            .await
            .expect("failed save cadet course if not exist");
    ...
    #[tokio::test]
    async fn should_find_cadet_course_entries_by_search_request_case_another_specialty_code() {
        // Given
        let sut = sut().await;
        let cadet = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
        let cadet_course = sut
            ...
            .expect("failed save cadet course");
        let mut request = cadet_course_search_request(&cadet, &cadet_course);
        request.set_specialty_codes(Some(vec!["another_specialty_code".to_string()]));
    ...
    #[tokio::test]
    async fn should_find_cadet_course_entries_by_search_request_case_newer_updated_after() {
        // Given
        let sut = sut().await;
        let cadet = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
        let cadet_course = sut
            ...
            .expect("failed save cadet course");
        let mut request = cadet_course_search_request(&cadet, &cadet_course);
        request.set_updated_after(Some(
            cadet_course.updated_at().clone().unwrap_or_default() + 2000,
        ));
    ...
    #[tokio::test]
    async fn should_find_cadet_course_entries_by_search_request_case_older_updated_before() {
        // Given
        let sut = sut().await;
        let cadet = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
        let cadet_course = sut
            ...
            .expect("failed save cadet course");
        let mut request = cadet_course_search_request(&cadet, &cadet_course);
        request.set_updated_before(Some(
            cadet_course.updated_at().clone().unwrap_or_default() - 2000,
        ));
    ...
    async fn should_delete_cadet_course() {
        ...
        sut.delete_cadet_course(cadet_course.require_id().clone())
            .await
            .expect("failed delete cadet course");
        let result = sut
            .find_cadet_course_by_id(cadet_course.require_id().clone())
            .await
            .expect("failed find cadet courses");
    ...
    #[tokio::test]
    async fn should_delete_cadet_courses_by_search_request() {
        // Given
        let sut = sut().await;
        let cadet = sut.save_cadet(cadet(1)).await.expect("failed save cadet");
        let cadet_course = sut
        ...
        // When
        sut.delete_cadet_courses_by_search_request(request)
            .await
            .expect("failed delete cadet course");
        let result = sut
            .find_cadet_course_by_id(cadet_course.require_id().clone())
    ...
    fn cadet_course_search_request(
        ...
        SearchCadetCourseRequestBuilder::default()
            .tax_numbers(vec![cadet.tax_number().clone()])
            .last_names(vec![cadet.last_name().clone()])
            .categories(vec![cadet_course.category().clone()])
            .specialty_codes(vec![cadet_course.specialty_code().clone()])
            .birth_date_after(cadet.birth_date().clone() - 1000)
            .birth_date_before(cadet.birth_date().clone() + 1000)
