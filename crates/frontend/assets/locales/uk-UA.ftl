...
dialog-bulk-delete-confirmation = Бажаєте видалити { $bulk-size } записів?
...
dialog-db-restore-confirmation = Ви збираєтеся відновити базу даних із резервної копії. Це повністю видалить поточні записи та замінить їх даними з обраного архіву. Цю дію неможливо скасувати. Бажаєте продовжити?
dialog-db-backup-confirmation = Буде сформовано архів із файлу з зашифрованими даними та файлу з ключем. Подбайте про його безпечне зберігання. Бажаєте продовжити?
...
updated-after = Додано (з)
updated-before = Додано (по)
...
error-validation-invalid-m-d-y-date = дата не відповідає формату ДД.ММ.РРРР
...
enter-category = Введіть рівень підготовки
...
# EXCEL
excel-import-description = Імпорт даних із Excel файлу, починаючи з: аркуш { $sheet-number }, стовпець { $first-column }, рядок { $first-row }. Ви можете змінити ці налаштування під структуру вашого файлу.

sheet-number = Номер аркушу
first-row = Перший рядок
last-row = Останній рядок
first-column = Перший стовпець
validation = Валідація
choose-file = Файл

enter-sheet-number = Введіть аркуш
enter-first-row = Введіть перший рядок
enter-last-row = Введіть останній рядок
enter-first-column = Введіть перший стовпець

skip-optional-validation = { $value ->
[false] Повна
*[true] Часткова
}